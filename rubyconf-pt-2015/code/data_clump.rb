...
p Conference.new('Braga', nav_source: nav_source).directions(1, 2)
p Conference.new('Braga', nav_source: nav_source).distance(3, 4)
p Conference.new('Braga', nav_source: nav_source).needs_passport?(1, 2)
